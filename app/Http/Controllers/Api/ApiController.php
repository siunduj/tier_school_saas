...
class ApiController extends Controller
{
    ...
    public function getSettings(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'type' => 'required|in:student_privacy_policy,teacher_privacy_policy,contact_us,about_us,student_terms_condition,teacher_terms_condition,app_settings,fees_settings'
        ]);
    ...
    public function applyLeaves(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'reason'  => 'required',
            'files.*' => ['nullable|array', new MaxFileSize($file_upload_size_limit) ],
        ],[
