...
class StudentApiController extends Controller {
    ...
    #[NoReturn] public function login(Request $request) {
        $validator = Validator::make($request->all(), [
            'gr_number' => 'required|alpha_num',
            'password' => 'required',
            'school_code' => 'required|alpha_num',
        ], [
            'gr_number.required' => 'The GR number is required.',
            'gr_number.alpha_num' => 'The GR number must contain only letters and numbers.',
    ...
    public function getProfileDetails() {
        try {
            ...
            dd($studentData->extra_student_details);
            
            $studentData->extra_student_details = [];
            $data = array(
                'id'                => $studentData->id,
