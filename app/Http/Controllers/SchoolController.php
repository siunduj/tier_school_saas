...
class SchoolController extends Controller {
    ...
    public function index() {
        ...
        $demoSchool = $this->schoolsRepository->builder()->where('type', 'demo')->first() !== null ? 1 : 0;
        ...
        return view('schools.index', compact('packages','baseUrlWithoutScheme','school_code','prefix', 'demoSchool','extraFields'));
    }
