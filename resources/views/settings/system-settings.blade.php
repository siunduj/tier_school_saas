    ...
    <script>
         $(document).ready(function () {
            // set web_maintenance setting from database
             ...
             // set file_upload_size_limit setting from database
             $("#file_upload_size_limit").prop( "checked", false );
             if ($('#file_upload_size_limit').val() == 1) {
                 $("#file_upload_size_limit").prop( "checked", true );
             } else { 
                 $("#file_upload_size_limit").prop( "checked", false );
             }
