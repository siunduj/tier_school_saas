                                            ...
                                            <div class="d-flex">
                                                <div class="form-check w-fit-content">
                                                    <label class="form-check-label ml-4">
                                                        <input type="checkbox" id="createDemoSchool" class="form-check-input" name="create_demo_school" value="1">{{ __('create_demo_school') }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#createDemoSchool').on('change', function() {
                if ($(this).is(':checked')) {
