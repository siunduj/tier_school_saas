                            ...
                            <form action="{{ route('login') }}" id="frmLogin" method="POST" class="pt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="text" class="form-control rounded-lg form-control-lg"
                                        name="email" value="{{ isset($school) && $school->type == 'demo' ? 'demo@school.com' :old('email') }}" required autocomplete="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="password" type="password"
                                            class="form-control rounded-lg form-control-lg" name="password" required value="{{ isset($school) && $school->type == 'demo' ? '1234567890' : '' }}"
